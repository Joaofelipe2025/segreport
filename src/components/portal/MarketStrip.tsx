    ...
    <section className="rounded-xl bg-gradient-to-br from-forest-800 to-forest-900 px-4 py-5 text-white ring-1 ring-white/8 sm:px-7 sm:py-8">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        ...
        <Link
          ...
          className="group inline-flex items-center gap-2 rounded-full bg-lime-400 px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.04em] text-forest-800 transition-colors hover:bg-lime-500"
        >
          Ver no Hub
